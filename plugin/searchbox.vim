...
highlight link SearchBoxCurrentMatch IncSearch
...
command! -range -nargs=* SearchBoxGrep lua require('searchbox.command').run('grep', <line1>, <line2>, <count>, <q-args>)

command! SearchBoxClear lua require('searchbox').clear_matches()
command! -nargs=? SearchBoxGrepKill lua require('searchbox').grep_kill(<q-args>)
